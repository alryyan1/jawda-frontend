    ...
    <div className="container mx-auto py-4 sm:py-6 lg:py-8 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col sm:flex-row gap-3 items-end">
            <div className="space-y-1.5">
              <label htmlFor="year-select-patient-freq" className="text-xs font-medium">السنة</label>
              <Select 
      ...
      {reportData && !isLoading && (
        <>
          ...
          <Card>
            <CardHeader>
                <CardTitle>مخطط عدد المرضى الشهري</CardTitle>
            </CardHeader>
